...
public class TaoClient implements Client {
    ...
    public static void loadTest(int concurrentClients, int loadTestLength, int warmupOperations) throws InterruptedException {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (runType.equals("interactive")) {
                ...
                loadTest(concurrentClients, loadTestLength, warmupOperations);
